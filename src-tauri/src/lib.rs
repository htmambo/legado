...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            bookshelf::commands::bookshelf_remove,
            bookshelf::commands::bookshelf_set_private,
            ...
            booksource::engine::booksource_chapter_content,
            booksource::engine::booksource_explore,
            booksource::engine::booksource_http_proxy,
